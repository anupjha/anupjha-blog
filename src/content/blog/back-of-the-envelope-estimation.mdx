...
<Callout>
  Back-of-the-envelope calculations are a fundamental technique in software
  engineering used to determine optimal system architecture design. This
  methodology, widely adopted by major technology companies including Google,
  Meta, Amazon, and Microsoft, is a standard component of system design
  interviews. The core principle involves calculating approximate numerical
  estimates to inform architectural decisions and solution design.
</Callout>
